...
\section{Changes}
1.0.1: The only change since 1.00 is the inclusion of the LPPL license.

1.0.2: Added hyperlinks to the main document and cleaned up some text. Moved to GitHub
...
Please \url{https://github.com/josephcslater/IMAC/issues}{log an issue on GitHub}  if you find bugs in this. 
...
\url{https://github.com/josephcslater/IMAC}{GitHub}.
